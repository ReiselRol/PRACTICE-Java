...
public class Agile {
	...
	public static void showImage(String ubicacion) throws IOException {
		
		AgileImagen imagen = new AgileImagen(ubicacion);
...
class AgileImagen extends JPanel{
	...
	public AgileImagen (String ruta) throws IOException {
	...
	public void paint (Graphics graficos) {
		...
		String rutaImagen = "";
		for (int i = 3; i < ruta.length(); i++) rutaImagen += ruta.charAt(i);
		...
		graficos.drawImage(imagen ,0, 0, ancho, alto, this);
